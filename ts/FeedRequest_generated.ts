 ...
 */
subReqType():NS10566075735762053212.reactivemarkets.papi.SubReqType {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? /**  */ (this.bb!.readInt8(this.bb_pos + offset)) : NS10566075735762053212.reactivemarkets.papi.SubReqType.Subscribe;
};

/**
 * @returns reactivemarkets.papi.FeedType
 */
feedType():NS10566075735762053212.reactivemarkets.papi.FeedType {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? /**  */ (this.bb!.readInt16(this.bb_pos + offset)) : NS10566075735762053212.reactivemarkets.papi.FeedType.Default;
};
 ...
 */
static addSubReqType(builder:flatbuffers.Builder, subReqType:NS10566075735762053212.reactivemarkets.papi.SubReqType) {
  builder.addFieldInt8(1, subReqType, NS10566075735762053212.reactivemarkets.papi.SubReqType.Subscribe);
};
 ...
 */
static addFeedType(builder:flatbuffers.Builder, feedType:NS10566075735762053212.reactivemarkets.papi.FeedType) {
  builder.addFieldInt16(2, feedType, NS10566075735762053212.reactivemarkets.papi.FeedType.Default);
};
...
static createFeedRequest(builder:flatbuffers.Builder, reqIdOffset:flatbuffers.Offset, subReqType:NS10566075735762053212.reactivemarkets.papi.SubReqType, feedType:NS10566075735762053212.reactivemarkets.papi.FeedType, grouping:number, depth:number, frequency:number, marketsOffset:flatbuffers.Offset):flatbuffers.Offset {

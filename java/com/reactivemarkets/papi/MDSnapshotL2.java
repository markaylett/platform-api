...
public final class MDSnapshotL2 extends Table {
  ...
  public reactivemarkets.papi.MDLevel2 bidSide(int j) { return bidSide(new reactivemarkets.papi.MDLevel2(), j); }
  public reactivemarkets.papi.MDLevel2 bidSide(reactivemarkets.papi.MDLevel2 obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__vector(o) + j * 16, bb) : null; }
  public int bidSideLength() { int o = __offset(18); return o != 0 ? __vector_len(o) : 0; }
  public reactivemarkets.papi.MDLevel2.Vector bidSideVector() { return bidSideVector(new reactivemarkets.papi.MDLevel2.Vector()); }
  public reactivemarkets.papi.MDLevel2.Vector bidSideVector(reactivemarkets.papi.MDLevel2.Vector obj) { int o = __offset(18); return o != 0 ? obj.__assign(__vector(o), 16, bb) : null; }
  public reactivemarkets.papi.MDLevel2 offerSide(int j) { return offerSide(new reactivemarkets.papi.MDLevel2(), j); }
  public reactivemarkets.papi.MDLevel2 offerSide(reactivemarkets.papi.MDLevel2 obj, int j) { int o = __offset(20); return o != 0 ? obj.__assign(__vector(o) + j * 16, bb) : null; }
  public int offerSideLength() { int o = __offset(20); return o != 0 ? __vector_len(o) : 0; }
  public reactivemarkets.papi.MDLevel2.Vector offerSideVector() { return offerSideVector(new reactivemarkets.papi.MDLevel2.Vector()); }
  public reactivemarkets.papi.MDLevel2.Vector offerSideVector(reactivemarkets.papi.MDLevel2.Vector obj) { int o = __offset(20); return o != 0 ? obj.__assign(__vector(o), 16, bb) : null; }
